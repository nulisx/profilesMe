...
function VideoWithFallback({ videoSrc, imageSrc }: v) {
...
export const MacbookScroll = ({
  ...
  return (
    <div
  ref={ref}
  className="min-h-[100vh] flex flex-col items-center py-4 md:py-10 justify-center flex-shrink-0 [perspective:800px] transform md:scale-100 scale-[0.6] sm:scale-50 mt-[-120px] sm:-mt-5 -mb-0"
>
      <motion.h2
        style={{
        ...
        className="dark:text-white text-neutral-800 text-3xl font-bold mb-6 text-center mt-[-22px]"
      >
        {title || (
          <span>
           Customise your background to <br />  showcase your links.
          </span>
        )}
      </motion.h2>
      {/* Lid */}
...
export const Lid = ({
  ...
  src={Image}
  alt="Sadanand"
  className="object-cover absolute inset-0 h-full w-full rounded-lg"
/> */}
<VideoWithFallback
  videoSrc={v}
  imageSrc={Image}
